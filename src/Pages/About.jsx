    ...
    >
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
             Computer Science student at Nile University and Fortinet Cybersecurity Engineer Intern at DEPI. I specialize in data science, applied machine learning, and cybersecurity, with experience building scalable ML pipelines, automating threat analysis, and enhancing anomaly detection using statistical and AI models.
            </p>
      ...
      >
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "I am passionate about applying AI responsibly as a professional tool — enhancing human capability, not replacing it."
        </blockquote>
      </div>

            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="/Shahd_Mansour_CV.pdf" className="w-full lg:w-auto" target="_blank" rel="noopener noreferrer" download>
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
