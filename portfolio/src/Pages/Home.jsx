...
const WORDS = ["Data scientist", "Fortinet Cybersecurity Engineer Intern", "ML Enthusiast"];
const TECH_STACK = [
  "Python",
  "SQL",
  "C/C++",
...
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/shaahdmaansour" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/shahdmansour" },
  { icon: Instagram, link: "https://www.instagram.com/shaahdmaansour" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Building Scalable AI, Data-Driven Insights, and Secure Digital Solutions.
                </p>
